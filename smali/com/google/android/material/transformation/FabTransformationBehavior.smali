...
.method public v(Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    .line 7
    invoke-static/range {p2 .. p2}, Lfx0$i;->i(Landroid/view/View;)F

    move-result v7

    invoke-static/range {p1 .. p1}, Lfx0$i;->i(Landroid/view/View;)F
    ...
    .line 11
    :goto_0
    iget-object v11, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lu70;

    const-string v12, "elevation"

    invoke-virtual {v11, v12}, Lu70;->f(Ljava/lang/String;)Lv70;

    move-result-object v11

    .line 12
    invoke-virtual {v11, v7}, Lv70;->a(Landroid/animation/Animator;)V
    ...
    .line 15
    iget-object v11, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Lcd0;

    invoke-virtual {v0, v1, v2, v11}, Lcom/google/android/material/transformation/FabTransformationBehavior;->x(Landroid/view/View;Landroid/view/View;Lcd0;)F

    move-result v11

    .line 16
    iget-object v12, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Lcd0;

    invoke-virtual {v0, v1, v2, v12}, Lcom/google/android/material/transformation/FabTransformationBehavior;->y(Landroid/view/View;Landroid/view/View;Lcd0;)F
    ...
    .line 24
    invoke-virtual {v0, v4, v14, v11, v8}, Lcom/google/android/material/transformation/FabTransformationBehavior;->z(Lcom/google/android/material/transformation/FabTransformationBehavior$b;Lv70;FF)F

    move-result v11

    .line 25
    invoke-virtual {v0, v4, v13, v12, v8}, Lcom/google/android/material/transformation/FabTransformationBehavior;->z(Lcom/google/android/material/transformation/FabTransformationBehavior$b;Lv70;FF)F
    ...
    .line 37
    :goto_1
    invoke-virtual {v14, v6}, Lv70;->a(Landroid/animation/Animator;)V

    .line 38
    invoke-virtual {v13, v8}, Lv70;->a(Landroid/animation/Animator;)V
    ...
    .line 43
    iget-object v6, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Lcd0;

    invoke-virtual {v0, v1, v2, v6}, Lcom/google/android/material/transformation/FabTransformationBehavior;->x(Landroid/view/View;Landroid/view/View;Lcd0;)F

    move-result v6

    .line 44
    iget-object v7, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Lcd0;

    invoke-virtual {v0, v1, v2, v7}, Lcom/google/android/material/transformation/FabTransformationBehavior;->y(Landroid/view/View;Landroid/view/View;Lcd0;)F

    move-result v7

    .line 45
    invoke-virtual {v0, v6, v7, v3, v4}, Lcom/google/android/material/transformation/FabTransformationBehavior;->w(FFZLcom/google/android/material/transformation/FabTransformationBehavior$b;)Landroid/util/Pair;
    ...
    .line 52
    invoke-virtual {v11, v6}, Lv70;->a(Landroid/animation/Animator;)V

    .line 53
    invoke-virtual {v8, v7}, Lv70;->a(Landroid/animation/Animator;)V
    ...
    .line 56
    instance-of v6, v2, Lcom/google/android/material/circularreveal/c;
    ...
    .line 62
    :cond_9
    sget-object v11, Lzl;->a:Landroid/util/Property;
    ...
    .line 63
    :cond_a
    sget-object v12, Lzl;->a:Landroid/util/Property;
    ...
    .line 65
    iget-object v12, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lu70;

    const-string v13, "iconFade"

    invoke-virtual {v12, v13}, Lu70;->f(Ljava/lang/String;)Lv70;

    move-result-object v12

    .line 66
    invoke-virtual {v12, v11}, Lv70;->a(Landroid/animation/Animator;)V
    ...
    invoke-direct {v11, v0, v7, v8}, Lcom/google/android/material/transformation/b;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Lcom/google/android/material/circularreveal/c;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 73
    invoke-virtual {v0, v1, v12}, Lcom/google/android/material/transformation/FabTransformationBehavior;->A(Landroid/view/View;Landroid/graphics/RectF;)V
    ...
    .line 75
    invoke-virtual {v0, v2, v13}, Lcom/google/android/material/transformation/FabTransformationBehavior;->A(Landroid/view/View;Landroid/graphics/RectF;)V
    ...
    invoke-virtual {v12, v13}, Lcom/google/android/material/floatingactionbutton/FloatingActionButton;->g(Landroid/graphics/Rect;)Z
    ...
    .line 90
    iget-object v13, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lu70;

    const-string v14, "expansion"

    invoke-virtual {v13, v14}, Lu70;->f(Ljava/lang/String;)Lv70;
    ...
    .line 91
    new-instance v9, Lcom/google/android/material/circularreveal/c$e;

    invoke-direct {v9, v11, v10, v12}, Lcom/google/android/material/circularreveal/c$e;-><init>(FFF)V

    invoke-interface {v8, v9}, Lcom/google/android/material/circularreveal/c;->setRevealInfo(Lcom/google/android/material/circularreveal/c$e;)V

    :cond_d
    if-eqz p4, :cond_e

    .line 92
    invoke-interface {v8}, Lcom/google/android/material/circularreveal/c;->getRevealInfo()Lcom/google/android/material/circularreveal/c$e;

    move-result-object v9

    iget v12, v9, Lcom/google/android/material/circularreveal/c$e;->c:F
    ...
    .line 93
    invoke-static/range {v18 .. v23}, Lm91;->e(FFFFFF)F

    move-result v9

    .line 94
    invoke-static {v8, v11, v10, v9}, Lcom/google/android/material/circularreveal/a;->a(Lcom/google/android/material/circularreveal/c;FFF)Landroid/animation/Animator;
    ...
    invoke-direct {v14, v0, v8}, Lcom/google/android/material/transformation/c;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Lcom/google/android/material/circularreveal/c;)V

    invoke-virtual {v9, v14}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    .line 96
    iget-wide v14, v13, Lv70;->a:J
    ...
    .line 102
    invoke-static {v8, v11, v10, v12}, Lcom/google/android/material/circularreveal/a;->a(Lcom/google/android/material/circularreveal/c;FFF)Landroid/animation/Animator;
    ...
    .line 109
    iget-wide v6, v13, Lv70;->b:J

    .line 110
    iget-object v0, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lu70;

    move-object/from16 v21, v9

    .line 111
    iget-object v9, v0, Lu70;->a:Lbn0;
    ...
    invoke-virtual {v9, v11}, Lbn0;->l(I)Ljava/lang/Object;
    ...
    .line 114
    iget-wide v0, v9, Lv70;->a:J

    move-object/from16 v25, v8

    .line 115
    iget-wide v8, v9, Lv70;->b:J
    ...
    .line 117
    invoke-static {v2, v0, v10, v12, v12}, Landroid/view/ViewAnimationUtils;->createCircularReveal(Landroid/view/View;IIFF)Landroid/animation/Animator;
    ...
    .line 121
    :goto_8
    invoke-virtual {v13, v9}, Lv70;->a(Landroid/animation/Animator;)V
    ...
    invoke-direct {v0, v1}, Lqb;-><init>(Lcom/google/android/material/circularreveal/c;)V
    ...
    .line 127
    invoke-static/range {p1 .. p1}, Lfx0$i;->g(Landroid/view/View;)Landroid/content/res/ColorStateList;
    ...
    .line 129
    invoke-interface {v0, v3}, Lcom/google/android/material/circularreveal/c;->setCircularRevealScrimColor(I)V
    ...
    .line 135
    iget-object v4, v3, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lu70;

    const-string v7, "color"

    invoke-virtual {v4, v7}, Lu70;->f(Ljava/lang/String;)Lv70;

    move-result-object v4

    .line 136
    invoke-virtual {v4, v0}, Lv70;->a(Landroid/animation/Animator;)V
    ...
    .line 139
    :cond_18
    sget v0, Lqf0;->mtrl_child_content_container:I
    ...
    .line 140
    invoke-virtual {v4, v0}, Lcom/google/android/material/transformation/FabTransformationBehavior;->C(Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    .line 142
    :cond_1a
    invoke-virtual {v4, v2}, Lcom/google/android/material/transformation/FabTransformationBehavior;->C(Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    .line 145
    sget-object v7, Ljb;->a:Landroid/util/Property;
    ...
    .line 150
    :goto_10
    iget-object v3, v3, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lu70;

    const-string v7, "contentFade"

    invoke-virtual {v3, v7}, Lu70;->f(Ljava/lang/String;)Lv70;

    move-result-object v3

    .line 151
    invoke-virtual {v3, v0}, Lv70;->a(Landroid/animation/Animator;)V
    ...
    .line 154
    invoke-static {v0, v5}, Ljk1;->n(Landroid/animation/AnimatorSet;Ljava/util/List;)V
    ...
    invoke-direct {v3, v4, v6, v2, v5}, Lcom/google/android/material/transformation/FabTransformationBehavior$a;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;ZLandroid/view/View;Landroid/view/View;)V
...
.method public final w(FFZLcom/google/android/material/transformation/FabTransformationBehavior$b;)Landroid/util/Pair;
    ...
    .line 1
    :cond_2
    iget-object p1, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lu70;

    const-string p2, "translationXCurveUpwards"

    invoke-virtual {p1, p2}, Lu70;->f(Ljava/lang/String;)Lv70;

    move-result-object p1

    .line 2
    iget-object p2, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lu70;

    const-string p3, "translationYCurveUpwards"

    invoke-virtual {p2, p3}, Lu70;->f(Ljava/lang/String;)Lv70;
...
.method public final x(Landroid/view/View;Landroid/view/View;Lcd0;)F
    .locals 3
...
.method public final y(Landroid/view/View;Landroid/view/View;Lcd0;)F
    .locals 3
...
.method public final z(Lcom/google/android/material/transformation/FabTransformationBehavior$b;Lv70;FF)F
    .locals 8

    .line 1
    iget-wide v0, p2, Lv70;->a:J

    .line 2
    iget-wide v2, p2, Lv70;->b:J

    .line 3
    iget-object p1, p1, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lu70;

    const-string v4, "expansion"

    invoke-virtual {p1, v4}, Lu70;->f(Ljava/lang/String;)Lv70;

    move-result-object p1

    .line 4
    iget-wide v4, p1, Lv70;->a:J

    .line 5
    iget-wide v6, p1, Lv70;->b:J
    ...
    .line 6
    invoke-virtual {p2}, Lv70;->b()Landroid/animation/TimeInterpolator;
    ...
    .line 7
    sget-object p2, Lr1;->a:Landroid/animation/TimeInterpolator;

    invoke-static {p4, p3, p1, p3}, Lik;->a(FFFF)F
