...
.method public c()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR REPLACE `throttle_profile` SET `id` = ?,`name` = ?,`download_bandwidth` = ?,`upload_bandwidth` = ?,`latency` = ?,`download_delay` = ?,`upload_delay` = ?,`dns_delay` = ?,`from_user` = ?,`create_time_ms` = ? WHERE `id` = ?"
